    ...
    <section class="pudding-section" id="puddingSection">
        <div class="pudding-card" id="puddingCarousel">
            ...
            <div class="pudding-slide active" data-bg="{{ asset('images/home/hero1.jpg') }}">
                ...
                <p>Our classic vanilla pudding is layered with bananas and Oreo cookies for a dessert that has all the
                    flavors of cookies and cream. Available until August 24th!</p>
            ...
            <div class="pudding-slide" data-bg="{{ asset('images/home/hero2.jpg') }}">
                ...
                <p>Rich chocolate fudge pudding topped with whipped cream and sprinkles. Perfect for chocolate lovers and
                    for all occasions. Limited time only!</p>
            ...
            <div class="pudding-slide" data-bg="{{ asset('images/home/hero3.jpg') }}">
                ...
                <p>Fresh mixed berries with our signature vanilla custard. A refreshing summer treat that's both light and
                    satisfying. Available until september 27th!</p>
            ...
            <div class="pudding-slide" data-bg="https://images.unsplash.com/photo-1519869325930-281384150729">
                ...
                <p>Decadent caramel pudding with a crunchy toffee topping. A perfect balance of sweet and salty flavors and
                    for all occasions.</p>
                <a href="{{ route('products') }}" class="order-btn">LIMITED TIME ONLY</a>
            </div>
            ...
            <div class="pudding-slide" data-bg="https://images.unsplash.com/photo-1549007994-cb92caebd54b">
                ...
                <p>Our signature vanilla bean pudding made with real vanilla. Simple, creamy, and absolutely delicious
                    delight for kids and adults alike.</p>
                <a href="{{ route('products') }}" class="order-btn">ORDER NOW</a>
            </div>
                ...
                @foreach($occasions as $occasion)
                    <div class="col-md-6 col-lg-4">
                        <div class="gift-card h-100 position-relative overflow-hidden rounded-4 shadow-sm">
                            <img src="{{ asset($occasion['image']) }}" class="w-100 h-100 object-fit-cover"
                                alt="{{ $occasion['alt'] }}">
                            <div class="gift-overlay d-flex flex-column justify-content-center p-4">
                                ...
                                <a href="{{ route('products') . '?' . parse_url($occasion['route'], PHP_URL_QUERY) }}"
                                    class="btn btn-light align-self-center">Explore →</a>
                            </div>
                        </div>
                    </div>
                @endforeach
                                            ...
                                            <div class="testimonial-card h-100">
                                                <div class="testimonial-content">
                                                    <div class="rating mb-3">
                                                        @for($i = 1; $i <= 5; $i++)
                                                            <i
                                                                class="bi bi-star{{ $i <= $testimonial['rating'] ? '-fill' : '' }} {{ $i <= $testimonial['rating'] ? 'text-warning' : 'text-light' }}"></i>
                                                        @endfor
                                                        <span class="visually-hidden">Rating: {{ $testimonial['rating'] }} out of 5
                                                            stars</span>
                                                    </div>
